...
var productState = JSON.parse(localStorage.getItem("Data")) || [];
...
Store.subscribe(() => {
  console.log("not from app", Store.getState());
  //simulate axios.post(server/cart,{object})
  localStorage.setItem("mycart", JSON.stringify(Store.getState().cart));
  localStorage.setItem("mywishlist", JSON.stringify(Store.getState().wishlist));
});
